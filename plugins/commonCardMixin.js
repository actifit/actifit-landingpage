...
export const commonCardMixin = {
  ...
  methods: {
    ...
    calculatePostImages() {
      ...
      // *** FIX 2: Added cdn.steemitimages.com and 3speak hosts to trusted list ***
