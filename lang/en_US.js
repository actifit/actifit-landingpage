module.exports = {
  ...
  faq: {
	...
	a8: 'Actifit records your activity on a daily basis. Your activity count resets at midnight (although you can always post your activity count the next day by using the “yesterday” option in the dAPP).<br/>Keep in mind that you need to reach at least 5000 steps to get rewarded. In case you have less than 5000 AFIT tokens in your actifit.io, Hive Engine, Steem Engine and BSC wallet combined, you will not receive receive upvotes and SPORTS tokens but no AFIT tokens.<br/>Another way to earn tokens is by delegating part of your SP/HP to the @actifit account and upvoting other Actifit user posts (each upvote will result in extra Actifit tokens in your wallet!)<br/>To learn more about maximizing your AFIT rewards, check out this tutorial:<br/><li>on youtube <a href="https://www.youtube.com/watch?v=2CsvW-mqEs4">https://www.youtube.com/watch?v=2CsvW-mqEs4</a> </li><li>or on 3speak <a href="https://3speak.tv/watch?v=actifit-3speak/whngpmwx">https://3speak.tv/watch?v=actifit-3speak/whngpmwx</a></li>',
  q9: 'Where can I buy AFIT tokens to obtain AFIT rewards on my reports?',
  a9: 'You can buy AFIT tokens on Hive Engine, Steem Engine and Binance Smart Chain (BSC), which will all count to reaching the 5000 AFIT when you will receive AFIT rewards.',
	q10: 'How can I use my AFIT?',
	a10: 'Accumulating AFIT will increase your ranking and that will allow you to earn more rewards on your activity reports<br/>You can use your AFIT to purchase virtual gadgets or real products from our Actifit Market <a href="https://actifit.io/market">https://actifit.io/market</a> .<br/>You can also exchange your AFIT token for extra vote rewards',
	q11: 'Can I exchange my AFIT into other crypto?',
	a11: 'Yes, by transferring your earned AFIT to supported exchanges (<a href="https://hive-engine.com">Hive Engine</a>, <a href="https://steem-engine.net">Steem Engine</a> or <a href="https://defi.actifit.io/">BSC</a>), you can exchange them to supported tokens on these exchanges.',
  q12: 'How can I transfer my AFIT tokens from <a href="https://hive-engine.com">Hive Engine</a> to BSC?',
  a12: 'You can send AFIT tokens using the bridge function in your wallet on <a href="https://actifit.io">https://actifit.io</a>',
  q13: 'How do I fund my account with AFIT tokens on CEX, DEX-TRADE and Digifinex exchange?',
  a13: 'You can fund your account by transferring AFIT tokens from BSC (in BEP20 format) to these exchanges.',
	q14: 'Why do I need a funds password and how can I reset it?',
	a14: 'In order to move AFIT to the exchange, you will need to have a funds password. This password is different than your master account password and your keys. <br/>To create your funds password, head over to your wallet under <a href="https://actifit.io/wallet">https://actifit.io/wallet</a> and follow the instructions there.<br/>In case you forgot your funds password, you need to contact one of the moderators on actifit Discord (<a href="https://links.actifit.io/discord">https://links.actifit.io/discord</a>) ',
	q15: 'What is AFITX?',
	a15: 'AFITX is a special benefits token for Actifit users & AFIT token holders. Holding this token enables users to:<li> Move extra daily AFIT tokens to Hive Engine and Steem Engine</li><li>Increases user rank</li><li>Increases post rewards via our different rewarded tokens</li><li>Receive priority when exchanging AFIT for HIVE/STEEM upvotes</li><li>Participate in contests</li><br/>On Binance Smart Chain, AFITX will be used as a reward token and governance token.',
	q16: 'How do I earn AFITX tokens?',
	a16: 'Currently you earn AFITX tokens while providing liquitidy on Tribaldex diesel pools and in the near future on BSC as well.',
	q17: 'Why am I not able to post my Actifit Report from the Mobile App?',
	a17: 'Make sure you are using both the correct username and “private posting key” for your Actifit account. Actifit will automatically save your credentials when you post for the first time.<br/>You could be low on resource credits, which can be an issue when you have a limited amount of Hive Power / Steem Power. In this case you either need to wait till it has recovered or you need to add more Hive Power/Steem Power. More information on Resource credit can be found <a href="https://hive.blog/faq.html#How_do_Resource_Credits_work_on_the_Hive_blockchain">here</a>.<br/>We recommend that you have at least 15 HP and 15SP (if you want to post on Steem as well) in your account.<br/>If in doubt, contact support on <a href="https://links.actifit.io/discord">discord</a>.',
	q18: 'Why would I delegate Hive Power (HP)/Steem Power (SP) to Actifit?',
	a18: 'Delegators receive two types of rewards:<br/><li>Daily AFIT token rewards from a pool of AFIT tokens distributed proportionally amongst delegators</li><li>-and-</li><li>Weekly 5% beneficiary reward from Actifit posts, in HIVE/HBD and STEEM/SBD, proportionally amongst delegators.</li>',
	q19: 'How can I delegate to Actifit?',
	a19: 'To delegate, head over to your <a href="https://actifit.io/wallet">wallet</a>, set the amount and set target as @actifit account (default), use your private active key and you’re good to go.<br/>Make sure you leave at least 15 HP/SP undelegated in your account.<br/>Attention! If you plan to increase your delegation, you need to actually use the new total amount as the delegation amount, and not only the increased amount. Otherwise only the new amount will be used, and the remaining will be undelegated.',
	q20: 'How can I transfer AFIT to other Actifit accounts?',
	a20: 'AFIT tokens can be transferred from your Profile page in the wallet. After selecting the Tip AFIT button, enter the user name and the amount of AFIT to be sent.',
	q21: 'Why should I increase my user rank?',
	a21: 'Actifit innovated its own ranking system to qualify its users, and increase the rewards of those with a higher rank. User rank determines 25% of the total reward value. The ranking system is scaled from 0 (lowest) to 100 (highest), and is affected by a multitude of factors, while making it a dynamic system, as follows:<br/><li>Amount of Delegated Steem/HIVE Power (SP/HP)</li><li>Amount of Held AFIT Tokens</li><li>Total Activity Rewarded</li><li>Last 10 Days Activity Count</li><li>Amount of AFITX held on hive-engine.com, steem-engine.net and moving forward on BSC</li><br/>You can check more details about your rank on <a href="https://actifit.io/userrank">https://actifit.io/userrank</a> ',
	q22: 'How do I contact you if my question isn’t answered here?',
	a22: 'You can always contact us on one of the following<br/><li>Facebook: <a href="https://www.facebook.com/Actifit.fitness/">https://www.facebook.com/Actifit.fitness/</a> </li><li>Instagram: <a href="https://www.instagram.com/actifit.fitness/">https://www.instagram.com/actifit.fitness/</a> </li><li>Twitter: <a href="https://www.twitter.com/Actifit_fitness">https://www.twitter.com/Actifit_fitness</a> </li><li>Telegram: <a href="https://t.me/actifit">https://t.me/actifit</a> </li><li>Discord: <a href="https://links.actifit.io/discord">https://links.actifit.io/discord</a> </li><li>Youtube:  <a href="https://www.youtube.com/channel/UCNHxAGO79rXI7Hdiikwnqtw">https://www.youtube.com/channel/UCNHxAGO79rXI7Hdiikwnqtw</a> </li><li>Medium: <a href="https://medium.com/@actifit.fitness">https://medium.com/@actifit.fitness</a> </li>',
