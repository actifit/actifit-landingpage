module.exports = {
  Actifitter_Month_Title: 'Actifitter of the Month',
  Actifitter_Month_Rank: 'Rank',
  Actifitter_Month_Activity: 'Activity',
  Actifitter_Month_AFIT: 'AFIT earned',
  Actifitter_Month_Months_Active: 'Months active',
  Actifitter_Month_View_Profile: 'View profile',
  Actifitter_Month_CTA: 'Be our next success story — join Actifit!',
  ...
  Arena_Ends: 'Ends',
  Arena_Participate: 'Participate',
  Arena_Prizes: 'Prizes',
  Arena_Recurrence: 'Recurrence',
  Arena_Length: 'Length',
  Arena_How_It_Works: 'How it works',
  Arena_Standings: 'Standings',
  Arena_Back: 'Back to the Arena',
  Arena_Rank: 'Rank',
  Arena_Athlete: 'Athlete',
  Arena_Score: 'Score',
  ...
  Arena_Create_Subtitle: 'Set up your own fitness challenge — reward players with a badge, or fund an AFIT prize from your own balance.',
  Arena_Create_CTA: 'Create your own challenge',
  Arena_Create_Login: 'Log in to create a challenge',
  Arena_Step_Details: 'Details',
  Arena_Step_Rewards: 'Rewards',
  Arena_Step_Review: 'Review & publish',
  Arena_Field_Title: 'Challenge title',
  Arena_Field_Title_PH: 'e.g. October Step Sprint',
  Arena_Field_Type: 'Challenge type',
  Arena_Field_Tagline: 'Short tagline',
  Arena_Field_Tagline_PH: 'One line that sells your challenge',
  Arena_Field_HowItWorks: 'How it works',
  Arena_Field_HowItWorks_PH: 'Explain how players take part and how a winner is decided.',
  Arena_Field_Metric: 'Scored by',
  Arena_Field_Rule: 'Winning rule',
  Arena_Field_Threshold: 'Target value',
  Arena_Field_Start: 'Starts',
  Arena_Field_End: 'Ends',
  Arena_Field_Entry: 'Who can join',
  Arena_Entry_Free: 'Anyone (free entry)',
  Arena_Entry_Gated: 'Members active enough to qualify',
  Arena_Field_MinActivity: 'Minimum recent activity to join',
  Arena_Field_Visibility: 'Visibility',
  Arena_Reward_Type: 'How are players rewarded?',
  Arena_Reward_Badge: 'Badge only',
  Arena_Reward_Badge_Desc: 'Award winners a collectible badge. Free to create — open to everyone.',
  Arena_Reward_Afit: 'AFIT prize (self-funded)',
  Arena_Reward_Afit_Desc: 'Fund a real AFIT prize from your own balance. Winners split it 50 / 30 / 20.',
  Arena_Field_Badge: 'Badge name',
  Arena_Field_Badge_PH: 'e.g. October Sprinter',
  Arena_Field_Badge_Who: 'Who earns this badge?',
  Arena_Badge_Who_Winner: 'The winner only',
  Arena_Badge_Who_Top3: 'The top 3 finishers',
  Arena_Badge_Who_All: 'Everyone who completes it',
  Arena_Field_Prize: 'Prize pool (AFIT)',
  Arena_Fee_Line: 'Platform fee ({pct}%)',
  Arena_Total_Debit: 'Total deducted now',
  Arena_Your_Afit: 'Your AFIT balance',
  Arena_Funded_Gate: 'Funding a prize requires holding at least {min} AFIT.',
  Arena_Funded_Insufficient: 'Your balance does not cover the prize + fee.',
  Arena_Prize_Min: 'The prize must be at least {min} AFIT.',
  Arena_Funder_Note: 'As the funder you cannot win your own prize — any unpaid remainder is returned to you when the challenge settles.',
  Arena_Next: 'Next',
  Arena_Prev: 'Back',
  Arena_Publish: 'Publish challenge',
  Arena_Publishing: 'Publishing…',
  Arena_Create_Pending: 'Your challenge has been submitted to the chain. Once it is indexed (usually a few blocks) it will appear in the Arena — check back shortly.',
  Arena_Type_League: 'Leaderboard',
  Arena_Type_Daily: 'Daily goal',
  Arena_Type_Event: 'Timed event',
  Arena_Type_Duel: 'Duel (1-v-1)',
  Arena_Type_Brawl: 'Free-for-all',
  Arena_Metric_Activity: 'Total activity',
  Arena_Metric_Steps: 'Step count',
  Arena_Metric_Distance: 'Distance',
  Arena_Metric_Goal: 'Daily goal hits',
  Arena_Rule_Max: 'Highest total wins',
  Arena_Rule_Threshold: 'Reach a target',
  Arena_Rule_H2H: 'Head to head',
  Arena_Vis_Public: 'Public',
  Arena_Vis_Private: 'Private (invite / link only)',
  Arena_Deducted: 'deducted',
  Arena_Balance_Loading: 'Checking your AFIT balance…',
  Arena_Balance_Error: 'Could not load your AFIT balance — please refresh and try again.',
  Arena_Create_Failed: 'Could not publish the challenge. Please try again.',
  Arena_Review_Reward: 'Reward',
  Arena_Fair_Play_Skill: 'Free to enter and decided purely by verified activity — never a wager, never pay-to-win.',
  Arena_View_Arena: 'Go to the Arena',
  languages: 'Languages',
  ...
  HIVE_Transaction_History: 'HIVE Transaction History',
  ...
  Sort_By: 'Sort By',
  wallet_more: 'More',
  search_tokens_ph: 'Search tokens…',
  no_tokens_match: 'No tokens match your search.',
  wa_transfer: 'Transfer',
  wa_claimable: 'Claimable',
  wa_pending: 'Pending',
  wa_hp_deleg: 'HP Deleg.',
  wa_rc_deleg: 'RC Deleg.',
  wa_history: 'AFIT History',
  wa_bsc: 'BSC Address',
  ...
  Active: 'Active',
  market_state_activated: 'Activated',
  market_state_unavailable: 'Locked',
  Inactive: 'Inactive',
  ...
  home_arena_eyebrow:'New · The Arena',
  home_arena_title:'Step into The Arena',
  home_arena_desc:'Compete in fitness challenges and leagues — climb the leaderboards, hit your goals, and earn AFIT for staying active. Or launch your own challenge and rally the community.',
  home_arena_cta:'Browse challenges',
  home_arena_cta2:'Create a challenge',
...
recent_post:'Recent Posts',
  ...
  Short_preview_description: 'Short preview description',
  preview_description_help: 'This becomes the snippet under your link in Google and on social cards.',
  ...
  HP: "HP",
  MOVE_AFIT_SE_HE: "Move AFIT to Power",
  ...
  afit_transfer_error: "AFIT transfer failed. Please try again.",
  captcha_invalid: "Invalid captcha. Please try again.",
  hive_withdraw_progress: "Withdrawal in progress",
  invalid_username: "Invalid username.",
  max_amount_AFIT: "Amount exceeds the maximum allowed.",
  min_amount_AFIT: "Amount is below the minimum allowed.",
  moving_afit_se_power: "Moving AFIT to Power…",
