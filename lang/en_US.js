module.exports = {
  ...
  q2: 'How can I download the Actifit App',
	...
	a4: 'Actifit mainly runs on the Hive blockchain, hence why having a hive account is required. However, Actifit also supports and runs on other chains while providing its users with rewards on those chains, this includes the Blurt blockchain. Actifit has also deployed its tokens AFIT and AFITX on Binance Chain (BSC) as well.',
	q5: 'How do I benefit from using the Actifit application?',
	a5: 'By creating the social and reward dynamic, Actifit is here to provide you the motivation in raising your lifestyle to a healthier level. The application allows you to join a vibrant and active community that is health and fitness oriented as well as reward you with several digital tokens, including AFIT, HIVE, BLURT and SPORTS tokens for your everyday fitness activities.<br/>Fun fact: Actifit users are known amongst each other as Actifitters. 😀',
	...
	q8: 'Can I connect and sync my smart watch/wearable watch with the Actifit Application?',
	...
	a9: 'There could be several reasons that resulted in this. First of all, you want to make sure that you inserted the correct username and Private Posting key in the appropriate part of the login dashboard. Actifit will automatically save your credentials when you report for the first time.<br/> Secondly confirm that you have the most recent Actifit Mobile App installed on your device or simply uninstall and reinstall the application to your smart device.<br/> Lastly your account might be low on resources. On the Hive blockchain you need sufficient <a href="https://hive.blog/faq.html#How_do_Resource_Credits_work_on_the_Hive_blockchain">Resource Credits (RC)</a> while on the Blurt Blockchain you need sufficient BLURT tokens. We recommend that you have at least 15 HP on your Hive account and 8 BLURT on your Blurt account.<br/>If in doubt, contact support on <a href="https://links.actifit.io/discord">discord</a>.',
	...
	a13: 'Actifit has a daily reward cycle; it may take up to 48 hours before your report is rewarded with an upvote, AFIT and SPORTS tokens. When your report is still not rewarded after this time, please let us know on <a href="https://links.actifit.io/discord">discord</a>.',
	q14: 'Why didn’t I receive an AFIT reward after I published my report?',
	a14: 'To be eligible for an AFIT reward, you must have a minimum of 5,000 AFIT in your Actifit wallet or any of the exchanges we currently support, including Hive Engine and BSC wallets.',
  ...
  q17: 'Why would I delegate Hive Power to Actifit?',
  ...
  a21: 'You can send users a Tip for their report or comment by using the !AFIT command. For more info about tipping AFIT tokens, check out <a href="https://links.actifit.io/tipping-afit">this link</a>',
	q22: 'How can I transfer AFIT to other Actifit accounts from my Actifit wallet?',
	a22: 'AFIT tokens can be transferred from your Profile page in the wallet section. After selecting the "Tip AFIT" button, enter the username, the amount of AFIT to be sent and your funds password to send the tokens.',
	q23: 'What is a funds password on Actifit?',
	a23: 'The funds password is another layer of security we developed to protect your funds from getting stolen. For example, to move your AFIT tokens from our website to your Hive-Engine wallet, you must enter your funds password before the transaction can be executed. Your funds password differs from your Hive and Blurt Keys. To create your funds password, click <a href="https://actifit.io/wallet?action=set_funds_pass">here</a> and follow the instructions.<br/> Note: You need to transfer one HIVE or HBD to activate and verify your funds password.',
  ...
  q27: 'Can I transfer my AFIT tokens from Hive Engine to BSC?',
  ...
  q30: 'What is AFITX?',
	...
	a32: 'Actifit Market is an online marketplace that allows you spend your Afit tokens on health and fitness products, services, and Actifit gamifying items. Access the Actifit Market <a href="https://actifit.io/market">here</a>.',
  q33: 'What are Actifit gadgets?',
	...
	a34: 'This is a random prize draw event that occurs every four days, whereby one winner is randomly selected from all participants. You need to buy one or more gadgets from the market to participate. Every purchased gadget secures you one ticket into the draw, provided you own a minimum of 1,000 AFIT.',
	q35: 'Why does my account have different keys?',
	a35: 'Your Actifit account is at core a Hive (and other chains) account. As part of the hive chain, there are different layers for permissions for the account, which are distributed across key types. To transact daily on Actifit, you would normally need your "posting key", which only allows creating posts and upvotes, along some basic functionality. Your "active key” meanwhile allows you to transact with HIVE tokens. Always make sure to keep your keys safely stored, especially your master password.',
	q36: 'What if I lost my account keys?',
	a36: 'It is always critical to keep a backup of your passwords and your keys. This is of utmost importance on the blockchain world. Losing your master password and active key is a big problem, as it would redeem your account financially inaccessible. For more about key permissions and uses, check the question above.',
	q37: 'How do I access or change my keys?',
	a37: 'You can find your keys by logging in to your account on <a href="https://actifit.io/password">actifit password management</a>, which would allow you to reveal all your keys, provided you have a copy of your master password. You can also change your keys from that same interface in case you suspect your password/keys have been exposed.',
	q38: 'Are my funds safe if I log in with my posting key on the Actifit Application?',
	a38: 'Yes, your funds are 100% safe. The only key required to use the Actifit mobile application is your posting key. By using your posting key to log into the Actifit Mobile application, you grant us access to publish your reports to the blockchain. Posting keys cannot be used to transfer funds.',
