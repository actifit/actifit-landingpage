module.exports = {
  ...
  faq: {
	...
	a4: 'By creating the social and reward dynamic, Actifit is here to provide you the motivation raising your lifestyle to a healthier level. Via Actifit, you join a vibrant and active community that is health and fitness oriented, but also rewarding you with tokens including AFIT, HIVE, BLURT, SPORTS Tokens and much more.<br/>Actifit users are known amongst each other as Actifitters 😀',
  ...
  a10: 'You can buy AFIT tokens on <a href="https://hive-engine.com">Hive Engine</a>, <a href="https://defi.actifit.io/">BSC</a>, <a href="https://pancakeswap.finance/swap?inputCurrency=BNB&outputCurrency=0x4516bb582f59befcbc945d8c2dac63ef21fba9f6">Pancakeswap(BSC Version)</a>, <a href="https://www.digifinex.com/en-ww/trade/USDT/AFIT">Digifinex</a>, or <a href="https://dex-trade.com/spot/trading/AFITUSDT">Dex-trade</a>',
  ...
  a13: 'You can transfer AFIT tokens using the option "Move AFIT Daily to H-E" in your <a href="https://actifit.io/wallet">wallet</a>, where you can set the number of tokens you want to transfer daily to Hive Engine.<br/>Keep in mind that you need to have at least 10,000 AFIT in your wallet to send tokens. Once you initiate the transer, it will keep occurring daily for 7 days. You can always cancel out the transfers or renew them using same process',
  ...
  a16: 'You can fund your account by transferring AFIT tokens from your BSC wallet (in BEP20 format) to these exchanges.',
	...
	a17: 'Your funds password allows you to perform several key functionality in your actifit wallet. For instance, to move AFIT to Hive-Engine, you need a funds password. This password is different from your HIVE master account password and your HIVE keys. <br/>To create your funds password, head over to your <a href="https://actifit.io/wallet?action=set_funds_pass">wallet</a> and follow the instructions. You will need to transfer 1 HIVE/HBD to activate and verify your password.<br/>In case you forgot your funds password, you can reset your password using the same interface and set a new one.',
	q18: 'What is AFITX?',
	a18: 'AFITX is a special benefits token for Actifit users & AFIT token holders. Holding this token enables users to:<li> Move extra daily AFIT tokens to Hive Engine</li><li>Increases user rank</li><li>Increases post rewards via our different rewarded tokens</li><li>Receive priority when exchanging AFIT for HIVE upvotes</li><li>Participate in contests</li><br/>On Binance Smart Chain, AFITX will be used as a reward token and governance token.',
	...
	a20: 'Make sure you are using both the correct username and “private posting key” for your Actifit report. Actifit will automatically save your credentials when you report for the first time.<br/>You could be low on Resource Credits, which can cause problems when you have a limited amount of Hive Power. In this case you either need to wait till your RC has recovered, or you need to increase your Hive Power. More information about Resource Credit can be found <a href="https://hive.blog/faq.html#How_do_Resource_Credits_work_on_the_Hive_blockchain">here</a>.<br/>We recommend that you have at least 15 HP <br/>If in doubt, contact support on <a href="https://links.actifit.io/discord">discord</a>.',
	q21: 'Why would I delegate Hive Power to Actifit?',
	a21: 'Delegators receive several types of rewards:<br/><li>Daily AFIT token rewards from a pool of AFIT tokens distributed proportionally amongst delegators</li><li>Weekly 5% beneficiary reward from Actifit posts, in HIVE/HBD, proportionally amongst delegators</li><li>Increased User Rank based on delegated amount</li>',
	q22: 'How can I delegate to Actifit?',
	a22: 'To delegate, head over to your <a href="https://actifit.io/wallet">wallet</a>, set the number of tokens and enter @actifit as target account (default). Use your private active key to confirm the transaction and you’re good to go.<br/>Make sure you leave at least 15 HP undelegated in your account. Furthermore, if you plan to increase your delegation, you need to use the new total amount as delegation amount so not only the increased amount. Otherwise only the new amount will be used, and the remaining will be undelegated.',
