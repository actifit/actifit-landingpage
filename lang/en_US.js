module.exports = {
  ...
  prize_tickets_buy_gadgets: 'Draw Prize Tickets ',
  tickets_collected: 'tickets collected',
  prize_pool: 'Prize Pool',
  Ready: 'Ready',
  next_draw: 'Next Draw In ',
  weekly_pay_prize_desc: 'Actifit draw allows you to win by purchasing gadgets using HIVE and accumulating entry tickets. <ul class="no-bullets"><li><i class="fas fa-check text-success"></i>The more tickets you have, you are more likely to win the prize. </li><li><i class="fas fa-check text-success"></i>You need to have at least 1,000 AFIT in your wallet to get tickets. </li><li><i class="fas fa-check text-success"></i>For every single gadget you buy with HIVE, you receive 1 ticket.</li><li><i class="fas fa-check text-success"></i>The prize pool shows the current value of the pending reward.</li>',
