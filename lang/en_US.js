module.exports = {
  ...
  q2: 'How can I download the Actifit App',
	...
	a7: 'All you need is your mobile, the Actifit fitness App and an account on Actifit/HIVE.<br/>To post your recent fitness activities click the button â€œSend Postâ€ for iOS or â€œPost & Earnâ€ for Android to display the report creation page, which enables you to easily create and publish your fitness report.<br/>Note: You must include your login credentials, Username, and Private Posting key (for the first time only) for your reports to get published. Donâ€™t know how to find your posting key? <a href="https://actifit.io/signup">Click here</a> to recover it.',
	...
	a11: 'You must track a minimum of five thousand (5,000) steps within 24 hours to be eligible receiving an <a href="https://developers.hive.io/glossary/">upvote</a>, AFIT and SPORTS tokens from Actifit.<br/>Note: At midnight your activity count resets to zero but if you donâ€™t reach the minimum count at that time, you can still post your report but it wonâ€™t be rewarded.',
 	q12: 'I forgot to post my report last night, can I still send my results?',
 	a12: 'Yes, you can always post your activity count from the previous day by using the â€œyesterdayâ€ option in the App.',
	q13: 'I have sent my Actifit report but Iâ€™m not rewarded, what should I do?',
	...
	q14: 'Why didnâ€™t I receive an AFIT reward after I published my report?',
  ...
  a21: 'You can send users a Tip for their report or comment by using the !AFIT command. For more info about tipping AFIT tokens, check out <a href="https://links.actifit.io/tipping-afit">this link</a>',
	...
	a23: 'AFIT tokens can be transferred from the Profile page of the person you would like to tip. After selecting the "Tip AFIT" button, enter the amount of AFIT to be sent with your funds password and press â€œProceedâ€ to send the tokens.',
  ...
  a27: 'Yes, you can send AFIT tokens using the bridge function from your wallet on Hive Engine to your BSC wallet by using the bridge function on our websiteâ€™s wallet section. You can read more about it in this <a href="https://actifit.io/@actifit/afit-bridge-is-live--quick-tutorial-afit-turning-to-ultimate-scarcity-digifinex-results-in-progress">article</a>.',
  ...
  q33: 'What are Actifit gadgets?',
	...
	q39: 'How do I contact you if my question isnâ€™t answered here?',
  ...
  signup: {
	headline: 'Activate your Actifit account â€” $2',
	...
	hero_sub: 'One-time fee Â· No subscription Â· AFIT tokens credited instantly',
	fee_card_title: 'What your $2 covers',
	fee_card_item1: 'Activates your Actifit account permanently',
	fee_card_item2: 'Blocks bots and fake accounts â€” keeps rewards fair for real members',
	...
	why_fee_title: 'Why $2?',
	why_fee_body: 'Actifit rewards real activity with real tokens, which makes the network a target for bots and fake accounts. A small one-time activation fee solves this â€” it verifies you\'re a real person and keeps the reward pool fair for genuine members. You pay $2 once. You earn for a lifetime.',
	hive_toggle: 'What is Hive? (and why do I need a blockchain account?)',
	hive_title: 'What is Hive?',
	hive_body: 'Hive is the decentralized network that powers Actifit. When you sign up, you get a Hive account that lets you own your fitness data, earn AFIT tokens and post activity securely â€” with no company in the middle controlling your information. Your account and tokens belong to you, not Actifit. You control your own login keys â€” keep them safe.',
	...
	faq_a3: 'Head to the login page â€” you don\'t need to pay again.',
	login_cta: 'Already have an account? Log in',
	social_proof: 'Joined by 50,000+ movers worldwide',
	keys_warning: 'Store your password somewhere safe. Your keys are the only way to access your account â€” they cannot be reset.'
  },
  ...
  Steem_sent: "I've sent payment â€” activate my account",
  ...
  market_state_unavailable: 'Unavailable',
  Inactive: 'Inactive',
  ...
  proposal_modal_message: "Support Our partners HDev team's development & growth effort. Vote for their proposalâ¤ï¸",
