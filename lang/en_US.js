module.exports = {
  ...
  q33: 'What are Actifit gadgets?',
	...
	q39: 'I use Samsung Health (or another fitness app) — why aren’t my steps syncing to Actifit through Health Connect?',
	a39: 'Actifit reads your steps <b>from Health Connect</b>, so your steps must first reach Health Connect before Actifit can pick them up. Some apps — Samsung Health in particular — do not write steps into Health Connect automatically, which is the most common cause of missing data. To fix it:<br/><li><b>Allow Actifit to read your steps:</b> open the Health Connect app → "App permissions" (or "Data and access") and make sure <b>Actifit</b> is allowed to read Steps.</li><li><b>Let Samsung Health write to Health Connect:</b> open Samsung Health → tap the ⋮ menu (top right) → Settings → Health Connect → App permissions → Samsung Health, then enable "Steps" (or "Allow all"). To confirm, in Health Connect go to Data and access → Activity → Steps; Samsung Health should be listed under "Can write steps".</li><li><b>Give it time:</b> Samsung Health may take an hour or more to push data across, and it normally only syncs steps <b>going forward</b> — days recorded before you enabled the sync usually won’t show up.</li><li><b>If it still doesn’t work:</b> toggle Samsung Health’s Health Connect sync off and back on, enable "Sync with Samsung Cloud", then restart your phone. As a reliable workaround, a bridge app such as "Health Sync" can copy steps from Samsung Health into Health Connect, after which Actifit reads them correctly.</li><br/>This is a limitation in how Samsung Health (and some other apps) feed Health Connect, not in Actifit itself. If you’re still stuck, reach out to us on <a href="https://links.actifit.io/discord">discord</a>.',
	q40: 'How do I contact you if my question isn’t answered here?',
	a40: 'You can always contact us on one of the following<br/><li>Facebook: <a href="https://www.facebook.com/Actifit.fitness/">https://www.facebook.com/Actifit.fitness/</a> </li><li>Instagram: <a href="https://www.instagram.com/actifit.fitness/">https://www.instagram.com/actifit.fitness/</a> </li><li>Twitter: <a href="https://www.twitter.com/Actifit_fitness">https://www.twitter.com/Actifit_fitness</a> </li><li>Telegram: <a href="https://t.me/actifit">https://t.me/actifit</a> </li><li>Discord: <a href="https://links.actifit.io/discord">https://links.actifit.io/discord</a> </li><li>Youtube:  <a href="https://www.youtube.com/Actifitfitness">https://www.youtube.com/Actifitfitness</a> </li><li>Medium: <a href="https://medium.com/@actifit.fitness">https://medium.com/@actifit.fitness</a> </li>',
  },
  signup: {
