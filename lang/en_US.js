module.exports = {
  ...
  faq: {
	...
	a4: 'Actifit is here to provide you the motivation to raise your lifestyle to a healthier level, by creating the social and reward dynamic. Via Actifit, you join a vibrant and active community that is health and fitness oriented, but also earn token rewards including AFIT, STEEM, HIVE, SPORTS Tokens and much more.<br/>Actifit users are known amongst each other as Actifitters :)',
