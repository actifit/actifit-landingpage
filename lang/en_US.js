module.exports = {
  ...
  referral_notice: 'We know you love actifit, and you would love to share it with everyone! <br /> To make this more rewarding to you, we have setup an amazing reward system! <br /> For every referral that signs up to actifit using your link, you earn: <br /><ul><li>One time AFIT amount equal to 20% of the AFIT rewards your referral earns upon successful signup! (usually minimum 20 AFIT) </li><li> 20-35% of your referral\'s actifit report rewards for one month, across all tokens rewarded (AFIT, HIVE, ...) </li></ul>',
