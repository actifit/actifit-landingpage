module.exports = {
  ...
  faq: {
	...
	a1: 'Actifit is a health-focused social dapp that rewards your everyday activity! Using the Actifit mobile app on Android and iPhone allows you to earn crypto token rewards via auto-tracking your everyday activity. Read more about Actifit here in the <a href="https://actifit.io/whitepaper/Actifit_White_Paper.pdf">ActifitWhite Paper</a>',
	q2: 'Is the app available for Android and iOS?',
	a2: 'Yes! Actifit is available for download on both platforms. To download on your platform, follow the links below:<br/>Android: <a href="https://links.actifit.io/android">https://links.actifit.io/android</a><br/>iOS: <a href="https://links.actifit.io/ios">https://links.actifit.io/ios</a>',
	...
	a5: 'All you need is your mobile, Actifit fitness App, and an account on Actifit/HIVE.<br/>Upon reaching the minimum amount of 5000 steps or more, use your username and private posting key (for the first time only), fill the necessary fields and post your report!<br/>Note: If you don’t reach the minimum amount, you can still post your report but you won’t be rewarded.',
	...
	q7: 'Can I use a smart watch/wearable to sync data to Actifit?',
	a7: 'Yes, but it depends on your smartwatch and phone model. Currently Actifit supports syncing your activity data from any Fitbit. For Android devices this is currently the sole smart watch supported.<br/>For iOS users, there are many more options, as they can sync from their Apple watch and any of the thousands of devices that sync with the Apple Health app.',
	q8: 'How do I earn AFIT tokens?',
	a8: 'Actifit records your activity on a daily basis. Your activity count resets at midnight.<br/>Keep in mind that you need to reach at least 5000 steps to get rewarded. In case you have less than 5000 AFIT tokens in your actifit.io, Hive Engine, Steem Engine and BSC wallet combined, you will only receive upvotes and SPORTS tokens but no AFIT tokens.<br/>Another way to earn tokens is by delegating part of your SP/HP to the @actifit account and upvoting other Actifit user posts (each upvote will result in extra AFIT tokens in your wallet!)<br/>To learn more about maximizing your AFIT rewards, check out this tutorial:<br/><li>on youtube <a href="https://www.youtube.com/watch?v=2CsvW-mqEs4">https://www.youtube.com/watch?v=2CsvW-mqEs4</a> </li><li>or on 3speak <a href="https://3speak.tv/watch?v=actifit-3speak/whngpmwx">https://3speak.tv/watch?v=actifit-3speak/whngpmwx</a></li>',
  ...
  q10: 'Where can I buy AFIT tokens to obtain AFIT rewards on my reports?',
  a10: 'You can buy AFIT tokens on <a href="https://hive-engine.com">Hive Engine</a>, <a href="https://steem-engine.net">Steem Engine</a> or <a href="https://defi.actifit.io/">BSC</a>, which all count to reaching the 5000 AFIT for receiving AFIT rewards.',
	...
	a11: 'Accumulating AFIT will increase your ranking and that will allow you to earn more rewards on your activity reports<br/>You can use your AFIT to purchase virtual gadgets or real products from our Actifit Market (e.g. <a href="https://actifit.io/market">https://actifit.io/market</a>) .<br/>You can also exchange your AFIT token for extra vote rewards',
  ...
  a14: 'You can fund your account by transferring AFIT tokens from BSC (in BEP20 format) to these exchanges.',
	...
	a15: 'In order to move AFIT to the exchange, you will need to have a funds password. This password is different than your master account password and your keys. <br/>To create your funds password, head over to your wallet under <a href="https://actifit.io/wallet">https://actifit.io/wallet</a> and follow the instructions there.<br/>In case you forgot your funds password, you need to contact one of the moderators on actifit Discord (<a href="https://links.actifit.io/discord">https://links.actifit.io/discord</a>).',
	q16: 'What is AFITX?',
	...
	a17: 'Currently you earn AFITX tokens while providing liquitidy on Tribaldex diesel pools and in the near future on BSC as well.',
	q18: 'Why am I not able to post my Actifit Report from the Mobile App?',
	a18: 'Make sure you are using both the correct username and “private posting key” for your Actifit account. Actifit will automatically save your credentials when you post for the first time.<br/>You could be low on resource credits, which can be an issue when you have a limited amount of Hive Power / Steem Power. In this case you either need to wait till it has recovered or you need to add more Hive Power/Steem Power. More information on Resource credit can be found <a href="https://hive.blog/faq.html#How_do_Resource_Credits_work_on_the_Hive_blockchain">here</a>.<br/>We recommend that you have at least 15 HP and 15SP (if you want to post on Steem as well) in your account.<br/>If in doubt, contact support on <a href="https://links.actifit.io/discord">discord</a>.',
	q19: 'Why would I delegate Hive Power (HP)/Steem Power (SP) to Actifit?',
	a19: 'Delegators receive two types of rewards:<br/><li>Daily AFIT token rewards from a pool of AFIT tokens distributed proportionally amongst delegators</li><li>-and-</li><li>Weekly 5% beneficiary reward from Actifit posts, in HIVE/HBD and STEEM/SBD, proportionally amongst delegators.</li>',
	q20: 'How can I delegate to Actifit?',
	a20: 'To delegate, head over to your <a href="https://actifit.io/wallet">wallet</a>, set the amount and set target as @actifit account (default), use your private active key and you’re good to go.<br/>Make sure you leave at least 15 HP/SP undelegated in your account. Furthermore, if you plan to increase your delegation, you need to actually use the new total amount as delegation amount, and not only the increased amount. Otherwise only the new amount will be used, and the remaining will be undelegated.',
