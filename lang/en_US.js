module.exports = {
  ...
  faq: {
	...
	a1: 'Actifit is a health-focused social #move2earn dapp that rewards your everyday activity! Using the Actifit mobile app on Android or iPhone allows you to earn crypto token rewards via auto-tracking your daily activities. Read more about Actifit here in the <a href="https://actifit.io/whitepaper/Actifit_White_Paper.pdf">Actifit White Paper</a>',
	...
	a7: 'Yes, but it depends on your smartwatch and phone model:<br/><li>For Android devices only Fitbit wearables are supported at the moment.</li><li>For iOS phones, there are many more options available, including Fitbit, Apple Watch, and any smartwatch that can sync with the Apple Health app you will be able to use the device.',
	q8: 'How can I earn AFIT tokens?',
	a8: 'Actifit records your activity on a daily basis. Your activity count resets at midnight.<br/>Keep in mind that you need to reach at least 5000 steps to get rewarded.<br/>In case you have less than 5000 AFIT tokens in your Actifit.io, Hive Engine, Steem Engine and BSC wallets combined, you will only receive upvotes and SPORTS tokens.<br/>Another way to earn tokens is by delegating part of your Hive Power (HP) or Steem Power (SP) to the @actifit account (check out <a href="https://actifit.io/yieldfarming">yield farming page</a>). You can also upvote other Actifit user posts (each upvote will result in extra AFIT tokens in your actifit.io wallet as well!)<br/>To learn more about maximizing your AFIT rewards, check out this tutorial:<br/><li>on youtube <a href="https://www.youtube.com/watch?v=2CsvW-mqEs4">https://www.youtube.com/watch?v=2CsvW-mqEs4</a> </li><li>or on 3speak <a href="https://3speak.tv/watch?v=actifit-3speak/whngpmwx">https://3speak.tv/watch?v=actifit-3speak/whngpmwx</a></li>',
  q9: 'I forgot to post my report last night, can I still send my results?',
  a9: 'Yes, you can always post your activity count from the previous day by using the “yesterday” option in the app.',
  q10: 'Where can I buy AFIT tokens so I obtain AFIT rewards on my reports?',
  a10: 'You can buy AFIT tokens on <a href="https://hive-engine.com">Hive Engine</a>, <a href="https://steem-engine.net">Steem Engine</a>, <a href="https://defi.actifit.io/">BSC</a>, <a href="https://pancakeswap.finance/swap?inputCurrency=BNB&outputCurrency=0x4516bb582f59befcbc945d8c2dac63ef21fba9f6">Pancakeswap(BSC Version)</a>, <a href="https://www.digifinex.com/en-ww/trade/USDT/AFIT">Digifinex</a>, or <a href="https://dex-trade.com/spot/trading/AFITUSDT">Dex-trade</a>',
	...
	a12: 'Yes, transferring your earned AFIT to supported exchanges will allow you to exchange them to other tokens',
  q13: 'How can I transfer AFIT tokens from my Actifit wallet to Hive Engine?',
  a13: 'You can transfer AFIT tokens using the option "Move AFIT Daily to H-E" in your <a href="https://actifit.io/wallet">wallet</a>, where you can set the number of tokens you want to transfer daily to Hive Engine or Steem Engine.<br/>Keep in mind that you need to have at least 10,000 AFIT in your wallet to send tokens. Once you initiate the transer, it will keep occurring daily for 7 days. You can always cancel out the transfers or renew them using same process',
  ...
  a15: 'You can send AFIT tokens using the bridge function in your wallet on <a href="https://actifit.io">https://actifit.io</a>. You can read more about it in this <a href="https://actifit.io/@actifit/afit-bridge-is-live--quick-tutorial-afit-turning-to-ultimate-scarcity-digifinex-results-in-progress">article</a>.',
  q16: 'How do I fund my account with AFIT tokens on CEX, DEX-TRADE and Digifinex exchange?',
  a16: 'You can fund your account by transferring AFIT tokens from your BSC wallet (in BEP20 format) to these exchanges.',
	q17: 'Why do I need a funds password and how can I reset it?',
	a17: 'Your funds password allows you to perform several key functionality in your actifit wallet. For instance, to move AFIT to the Hive-Engine or Steem-Engine, you need a funds password. This password is different from your HIVE master account password and your HIVE keys. <br/>To create your funds password, head over to your <a href="https://actifit.io/wallet?action=set_funds_pass">wallet</a> and follow the instructions. You will need to transfer 1 HIVE/HBD to activate and verify your password.<br/>In case you forgot your funds password, you can reset your password using the same interface and set a new one.',
	q18: 'What is AFITX?',
	a18: 'AFITX is a special benefits token for Actifit users & AFIT token holders. Holding this token enables users to:<li> Move extra daily AFIT tokens to Hive Engine</li><li>Increases user rank</li><li>Increases post rewards via our different rewarded tokens</li><li>Receive priority when exchanging AFIT for HIVE/STEEM upvotes</li><li>Participate in contests</li><br/>On Binance Smart Chain, AFITX will be used as a reward token and governance token.',
	q19: 'How do I earn AFITX tokens?',
	a19: 'Currently you earn AFITX tokens via providing liquitidy on <a href="https://tribaldex.com/dieselpools/">Tribaldex diesel pools</a> and in the near future on BSC as well.',
	q20: 'Why am I not able to post my Actifit Report from the Mobile App?',
	a20: 'Make sure you are using both the correct username and “private posting key” for your Actifit report. Actifit will automatically save your credentials when you report for the first time.<br/>You could be low on Resource Credits, which can cause problems when you have a limited amount of Hive Power / Steem Power. In this case you either need to wait till your RC has recovered, or you need to increase your Hive Power/Steem Power. More information about Resource Credit can be found <a href="https://hive.blog/faq.html#How_do_Resource_Credits_work_on_the_Hive_blockchain">here</a>.<br/>We recommend that you have at least 15 HP and 15SP (in case you post on Steem as well).<br/>If in doubt, contact support on <a href="https://links.actifit.io/discord">discord</a>.',
	q21: 'Why would I delegate Hive Power/Steem Power to Actifit?',
	a21: 'Delegators receive several types of rewards:<br/><li>Daily AFIT token rewards from a pool of AFIT tokens distributed proportionally amongst delegators</li><li>Weekly 5% beneficiary reward from Actifit posts, in HIVE/HBD and STEEM/SBD, proportionally amongst delegators</li><li>Increased User Rank based on delegated amount</li>',
	...
	a25: 'Actifit mainly runs on the Hive blockchain as its core blockchain, hence why having a hive account is required. Actifit also supports and runs on other chains, while providing its users with rewards on those chains. Those include Steem and Blurt chains. Actifit also recently deployed its tokens AFIT and AFITX on Binance Chain (BSC) as well.',
	q26: 'Why does my account has different keys?',
	a26: 'Your actifit account is at core a hive (and other chains) account. As part of the hive chain, there are different layers for permissions for the account, which are distributed across key types. To transact daily on actifit, you would normally need your "posting key", which only allows creating posts and upvotes, along some basic functionality. Your "active" key meanwhile allows you to transact with HIVE tokens. Always make sure to keep your keys safely stored, especially your master password.',
	q27: 'What if i lost my account keys?',
	a27: 'It is always critical to keep a backup of your passwords and your keys. This is of utmost importance on the blockchain world. Losing your master password and active key is a big problem, as it would redeem your account financially inaccessible. For more about key permissions and uses, check question above.',
	q28: 'How do i access or change my keys?',
	a28: 'You can find your keys by logging in to your account on <a href="https://actifit.io/password">actifit password management</a>, which would allow you to reveal all your keys, provided you have a copy of your master password. You can also change your keys from that same interface in case you suspect your password/keys have been exposed.',
	q29: 'What is Actifit Gadget Prize Draw?',
	a29: 'This is an random prize draw event that occurs every 4 days, whereby one winner is randomly selected from all participatants. To participate, you simply need to buy one or more gadgets from the market. Every bought gadget secures you 1 ticket into the draw, provided you own a minimum of 1,000 AFIT.',
	q30: 'What are actifit gadgets?',
	a30: 'Gadgets are virtual gamification items (NFT-like) that allow you to increase your actifit report rewards. They come into play during the reward cycle. If you have a report that is pending rewards, and you bought some gadgets, those will be consumed to increase your rewards. Each gadget has its own level, reward(boosts), validity, and requirements. Some gadgets increase your rewards, others reward a selected friend of yours. More details on <a href="https://actifit.io/market">actifit market page</a>.',
	q31: 'How do I contact you if my question isn’t answered here?',
	a31: 'You can always contact us on one of the following<br/><li>Facebook: <a href="https://www.facebook.com/Actifit.fitness/">https://www.facebook.com/Actifit.fitness/</a> </li><li>Instagram: <a href="https://www.instagram.com/actifit.fitness/">https://www.instagram.com/actifit.fitness/</a> </li><li>Twitter: <a href="https://www.twitter.com/Actifit_fitness">https://www.twitter.com/Actifit_fitness</a> </li><li>Telegram: <a href="https://t.me/actifit">https://t.me/actifit</a> </li><li>Discord: <a href="https://links.actifit.io/discord">https://links.actifit.io/discord</a> </li><li>Youtube:  <a href="https://www.youtube.com/channel/UCNHxAGO79rXI7Hdiikwnqtw">https://www.youtube.com/channel/UCNHxAGO79rXI7Hdiikwnqtw</a> </li><li>Medium: <a href="https://medium.com/@actifit.fitness">https://medium.com/@actifit.fitness</a> </li>',
  },
  signup: {
