<template>
  <div :class="outserSmallScreenClasses" class="position-fixed text-brand mx-auto w-100 acti-notify-comp" >
	<div :class="smallScreenClasses" class="text-center mx-auto acti-notify-comp-inner border-2 rounded">
	  <div>CryptoFitChallenge 2022 is ON - Week 1 In Progress
	  ...
	  <transition name="fade">
		<div class="extra-info" v-if="showCompDetails">
		  <div class="img-container row">
			...
			<img class="announce-img" src="/img/cryptofitchallenge2022_week1.png" width="85%">
		  </div>
		  <div>
		  ...
		  <a href="https://actifit.io/@actifit/cryptofitchallenge2022-is-on-are-you-ready-for-1st-weeks-exercises" class="btn btn-brand m-2 back-red" target="_blank">Week 1 Exercises</a>
