...
async loginHiveauth (){
      ...
      async loginKeychain () {
        ...
        if (!this.keychain_available){ return; }
        if (this.$refs["username"].value == ''){ this.error_proceeding = true; this.error_msg = this.$t('login_error'); return; }
        ...
        let user_info = { 'username': account_name, 'bchain': this.bchain_val };
        try {
