  ...
  <div class="footer bg-light">
	...
	<div class="columns">
	  ...
	  <div class="text-center social-links mb-4">
        ...
        <a href="https://www.twitter.com/Actifit_fitness" target="_blank" class="d-inline-block mx-3 mt-3" :title="$t('Twitter')"><i class="fa-brands fa-x-twitter"></i></a>
      ...
      <div class="row">
        <div class="col text-center">
          <small class="text-muted">&copy; {{ $t('Copyright_Actifit') }} {{ currentYear }} | v1.4.8.5</small> |
