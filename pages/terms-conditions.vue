<template>
  ...
  <div>
    ...
    <div class="container pt-5 mt-5 pb-5">
      <h1 class="text-center mb-5 h2">TERMS OF SERVICE</h1>
...
<h4>SECTION 1 - ONLINE ACTIFIT TERMS</h4>
...
<h4>SECTION 11 - PERSONAL INFORMATION</h4>
