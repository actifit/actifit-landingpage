<template>
  <div class="home" ref="homePage">
    ...
    <div class="header pt-4 pt-md-5 position-relative">
      ...
      <!-- new header trending content section -->
      <CommunityCarousel community='hive-193552' type="trending" /> <!--process.env.actifit_community-->
    ...
    <section id="delegators" class="py-5">
      <div class="container">
        ...
        <div class="row">
          <div v-if="topDelegators.hive" class="col-6 col-sm-4 col-md-3 text-center mb-4"
            v-for="(delegator, index) in topDelegators.hive" :key="'hive' + index" :delegator="delegator">
        ...
        <div class="row">
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@mcfarhat" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/mohammadfarhat.jpg);'"></div>
            </a>
          ...
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@alfamano" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/alaafarhat.jpg);'"></div>
            </a>
            <a href="@alfamano" target="_blank">Alaa Farhat</a>
            <div><i>Business Development Manager</i></div>
            <a href="https://www.linkedin.com/in/alaa-farhat-b8b59317/" target="_blank"><i
                class="fab fa-linkedin"></i></a>
          </div>
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@pjansen" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/pauljansen.jpg);'"></div>
            </a>
          ...
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@rabihfarhat" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/rabihfarhat.jpg);'"></div>
            </a>
            <a href="@rabihfarhat" target="_blank">Rabih Farhat</a>
            <div><i>Finance Manager</i></div>
            <a href="https://www.linkedin.com/in/rabih-farhat-42a1604b/" target="_blank"><i
                class="fab fa-linkedin"></i></a>
          </div>
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@katerinaramm" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/katerinaramm.jpg);'"></div>
            </a>
            <a href="@katerinaramm" target="_blank">Katerina Ramoutsaki</a>
            <div><i>Social Media Manager</i></div>
            <a href="https://www.linkedin.com/in/katerina-ramoutsaki-25055697/" target="_blank"><i
                class="fab fa-linkedin"></i></a>
          </div>
        </div>
        <div class="row">
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@ciuoto" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/eugeniopirillo.jpg);'"></div>
            </a>
          ...
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@priyanarc" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/priyanfareen.jpg);'"></div>
            </a>
            <a href="@priyanarc" target="_blank">Priyan Fareen</a>
            <div><i>Moderator</i></div>
            <a href="https://www.linkedin.com/in/priyan-fareen-33722398/" target="_blank"><i
                class="fab fa-linkedin"></i></a>
          </div>
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@kpreddy" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/praveen.jpg);'"></div>
            </a>
            <a href="@kpreddy" target="_blank">Praveen Reddy</a>
            <div><i>Moderator</i></div>
            <a href="https://www.linkedin.com/in/praveen-reddy-kanthala-a0532011a/" target="_blank"><i
                class="fab fa-linkedin"></i></a>
          </div>
          <!--<div class="col-6 col-sm-4 col-md-3 text-center mb-4">
          ...
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@silvertop" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/silvertop.jpg);'"></div>
            </a>
          ...
          <div class="col-6 col-sm-4 col-md-3 text-center mb-4">
            <a href="@elizabethbit" target="_blank">
              <div class="avatar small mx-auto mb-3"
                :style="'background-image: url(https://usermedia.actifit.io/elizabethbit.jpg);'"></div>
            </a>
            <a href="@elizabethbit" target="_blank">Elizabeth Gutman</a>
            <div><i>Moderator</i></div>
            <a href="https://www.linkedin.com/in/elizabeth-gutman-33456536/" target="_blank"><i
                class="fab fa-linkedin"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-center mb-4" :title="$t('main_chain')">
            <img src="/img/HIVE.png" style="max-height: 150px;"><br /><span
              class="font-weight-bold">{{ $t('HIVE') }}</span>
          </div>
        </div>
        <div class="row" :title="$t('secondary_chains')">
          ...
          <div class="col-6 text-center mb-4">
            <img src="/img/BLURT.png" style="max-height: 100px;"><br /><span
              class="font-weight-bold">{{ $t('BLURT') }}</span>
          </div>

          <div class="col-6 text-center mb-4">
            <img src="/img/BNB_CHAIN.webp" style="max-height: 100px;"><br /><span
              class="font-weight-bold">{{ $t('BNB_CHAIN') }}</span>
          </div>
        </div>
      </div>
    </section>
