...
<div class="title-highlight-container">
  <div class="d-flex align-items-center title-highlight-box">
    ...
    <a href="#" class="info-icon" data-toggle="modal" data-target="#marketInfoModal">
      <i class="fas fa-info-circle" :title="$t('view_details')"></i>
    </a>
  </div>
</div>
...
<div class="filters-container">
  ...
  <a class="expand-btn" v-on:click="expandAllSwitchStatus" :class="expandAllStatus" :title="expandAllStatusText">
    <div class="expand-content">
      <div class="expand-text">{{ expandAllStatusText }}</div>
      <i class="fas expand-icon" :class="expandAllStatus === 'open' ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
    </div>
  </a>
</div>
  </div>
