  ...
  */
  head: {
    ...
    meta: [
	  ...
	  { hid: 'title', 'property':'og:title', content: 'Actifit - Rewarding Your Everyday Activity'},
	  { hid: 'ogdescription', 'property':'og:description', content: pkg.description},
      { hid: 'url', 'property':'og:url', content: 'https://actifit.io'},
	  { name: 'og:type', 'property':'og:type', content: 'website'},
	  { hid: 'image', 'property':'og:image', content: 'https://actifit.io/img/actifit_logo_med.png'},
	  { name: 'google-site-verification', content:'Dv3mVaav2x5_2FauDB6MRjixVtVVWPfjUekWwKY-Tnc' },
	  { 'property': 'fb:app_id', content: '651065985331472'},
    ],
    link: [
